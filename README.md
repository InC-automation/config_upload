...
>На момент разработки примера актуальной является версия python-3.13.7.
...
>Перед загрузкой конфигурации в Эликонт-КС следует проверить файл user_config.xml на соответствие схеме CsScheme.xsd. Схема находится в папке scheme.
